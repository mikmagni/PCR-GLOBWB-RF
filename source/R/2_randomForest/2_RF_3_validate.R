...
testStationInfo <- read.csv(paste0('../../../RF/rf_input/subsample_',subsample,'/test_stations.csv'))

outputDir <- paste0('../../../RF/validate/subsample_',subsample,'/')
dir.create(outputDir, showWarnings = F, recursive = T)
outputDirValidation <- paste0('../../../RF/validate/subsample_',subsample,'/')
